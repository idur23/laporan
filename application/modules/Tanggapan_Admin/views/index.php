		      ...
		      <div class="container">
		        <table id="table" class="table" border="1" cellspacing="0" width="100%">
		            	...
		            	<tr>
		            		...
		            		<td>
								<a href="<?php echo base_url('tanggapan_Admin/edit/'.$val['id_tanggapan']); ?>"><button class="btn btn-info">More</button></a>
								<a href="<?php echo base_url('tanggapan_Admin/hapus/'.$val['id_tanggapan']); ?>"><button class="btn btn-danger">Hapus</button></a>
							</td>
		            	</tr>
		            <?php } ?>
		        </table>
