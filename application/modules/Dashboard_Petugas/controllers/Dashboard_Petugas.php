...
class Dashboard_Petugas extends MX_Controller {
	...
	function index()
	{
		...
		$data['title'] = 'Pelaporan Pengaduan Masyrakat';
		$this->load->view('dashboard_petugas', $data);
	}
	function index_user()
	{
		$this->load->view('user');
	...
	{
		$where = array('id'=> $id);
		$this->dashboard->hapus_data($where,'rincian_buku');
